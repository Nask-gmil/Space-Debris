...
export const Constants = {
  ...
  //   8000kcal（巨星の閾値）を超えた後も上限なく育ち続ける。
  //   ここに書いてある size（17）はその「出発点のサイズ」であり、
  //   実際のサイズは FINAL_STAGE_GROWTH の設定に従って加算される。
  //   （計算方法は Star.js の getEvolutionStageSize() を参照）
  EVOLUTION_STAGES: [
    { threshold: 300, stage: '小惑星', size: 1.5, color: 0x888888, emissive: false },     // 灰色
    { threshold: 800, stage: '微惑星', size: 2.2, color: 0xAAAAAA, emissive: false },     // 明るい灰色
    { threshold: 1500, stage: '準惑星', size: 3, color: 0xC2B280, emissive: false },      // 淡い茶色（冥王星のイメージ）
    ...
    { threshold: 7000, stage: '恒星', size: 10, color: 0xFFFF00, emissive: true },         // 黄色
    { threshold: 8000, stage: '巨星', size: 13, color: 0xFFA500, emissive: true },         // 橙
  ...
  // 【初心者向け解説】
  // 「巨星の閾値（8000kcal）を超えてから、calorieStep（1000kcal）ごとに
